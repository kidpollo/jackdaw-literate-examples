...
#+RESULTS:
: #:clojure.spec.alpha{:problems ({:path [], :pred (clojure.core/fn [%] (clojure.core/contains? % :opportunity-id)), :val {:employee-count "2", :primary-phone "1-800-EMPIRE", :city-name "bar", :state-code "AZ", :business-name "foo", :tax-id "1", :loan-application-id #uuid "8a0c569a-237c-4f8d-bc11-80becd6493b1", :zip-code "666", :street-name "Abbey Road", :requested-amount "100"}, :via [:prod-app.specs.reader-specs/loan-application], :in []} {:path [:tax-id], :pred :clojure.spec.alpha/unknown, :val "1", :via [:prod-app.specs.reader-specs/loan-application :company/tax-id], :in [:tax-id]}), :spec :prod-app.specs.reader-specs/loan-application, :value {:employee-count "2", :primary-phone "1-800-EMPIRE", :city-name "bar", :state-code "AZ", :business-name "foo", :tax-id "1", :loan-application-id #uuid "8a0c569a-237c-4f8d-bc11-80becd6493b1", :zip-code "666", :street-name "Abbey Road", :requested-amount "100"}}
...
#+begin_EXPORT json
{
  "timestamp" : "2020-06-18T22:29:51.673Z",
  "level" : "INFO",
  "thread" : "nREPL-session-92ad42cc-9e1f-4785-80c6-cdbf644d323a",
  "loan-application-id" : "972d6828-d9eb-561f-9c72-5cf457636669",
  "sba-loan-number" : "RGvi9jKVve",
  "ns" : "prod-app.log",
  "line" : 53,
  "opportunity-id" : "45ikm1PGkT4ai1f9Z6e",
  "column" : 17,
  "event" : "loan-application-attribute-validation-success",
  "logger" : "prod-app.log",
...
{
  "timestamp" : "2020-06-18T22:29:51.674Z",
  "level" : "INFO",
  "thread" : "nREPL-session-92ad42cc-9e1f-4785-80c6-cdbf644d323a",
  "loan-application-id" : "972d6828-d9eb-561f-9c72-5cf457636669",
  "sba-loan-number" : "RGvi9jKVve",
...
writing results to './test-results/journal-1592519394812'
