...
writing results to './test-results/journal-1592788219266'
...
#+begin_export json
{
  "timestamp" : "2020-06-22T01:10:45.003Z",
  "level" : "INFO",
  ...
  "published-timestamp" : 1592788244409,
  "column" : 17,
  "requested-amount" : "1",
...
#+BEGIN_SRC bash :dir prod-app :results output :exports both :wrap export json
docker run --tty \
  --network host \
  edenhill/kafkacat:1.5.0 \
  kafkacat -e -q  -b localhost:9092 \
