...
#+RESULTS:
: {:pipe-app
:  #object[org.apache.kafka.streams.KafkaStreams 0x27ac51aa "org.apache.kafka.streams.KafkaStreams@27ac51aa"]}
...
:  #object[org.apache.kafka.streams.KafkaStreams 0x27ac51aa "org.apache.kafka.streams.KafkaStreams@27ac51aa"],
:  :flex-app
:  #object[org.apache.kafka.streams.KafkaStreams 0x280a694b "org.apache.kafka.streams.KafkaStreams@280a694b"]}
...
#+RESULTS:
#+begin_example
([[#uuid "b89b1fa6-d921-489b-aa1b-bbf5b1392387"
   #uuid "33d25349-31fa-4d77-b377-d2da431bb739"]
  {:count 1,
   :sum 1,
   :name "step counter",
   :user-id #uuid "b89b1fa6-d921-489b-aa1b-bbf5b1392387"}]
 [[#uuid "b89b1fa6-d921-489b-aa1b-bbf5b1392387"
   #uuid "279c133a-5fd4-4877-915a-5229463d6d42"]
  {:count 1,
   :sum 2,
   :name "pushup counter",
   :user-id #uuid "b89b1fa6-d921-489b-aa1b-bbf5b1392387"}]
 [[#uuid "cec3d863-2780-4524-956b-8faa9d9f8c9f"
   #uuid "fac301de-0355-4e9c-a189-14f5bace33b4"]
  {:count 1,
   :sum 100,
   :name "step counter",
   :user-id #uuid "cec3d863-2780-4524-956b-8faa9d9f8c9f"}]
 [[#uuid "b89b1fa6-d921-489b-aa1b-bbf5b1392387"
   #uuid "279c133a-5fd4-4877-915a-5229463d6d42"]
  {:count 2,
   :sum 102,
